...
import { Github, Linkedin, Mail, MapPin, Calendar, Code, BookOpen } from 'lucide-react';

export default function About() {
  const skills = [
    'React', 'TypeScript', 'Next.js', 'Node.js', 'Express', 'PostgreSQL',
    'TailwindCSS', 'Prisma', 'GraphQL', 'AWS', 'Docker', 'Git'
  ];
  ...
  const experience = [
    {
      ...
      period: '2022 - Present',
      description: 'Leading development of modern web applications using React and TypeScript.'
    },
    {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="text-center mb-16">
            <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-primary to-primary/70 rounded-full flex items-center justify-center">
              <span className="text-primary-foreground font-bold text-4xl">DS</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              About DevShowcase
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Welcome to my digital space where I share my journey in web development, 
              showcase projects, and explore the latest technologies shaping our industry.
            </p>
          </div>
          ...
          <Card className="mb-12">
            <CardHeader>
              ...
              <CardDescription>Full Stack Developer & Tech Enthusiast</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="leading-relaxed">
                I'm a passionate full stack developer with over 5 years of experience building 
                modern web applications. I specialize in React, TypeScript, and Node.js, with 
                a keen interest in creating user-friendly interfaces and scalable backend systems.
              </p>
              <p className="leading-relaxed">
